...
<head>
    ...
    <script>
        ...
        function editForm(index) {
            ...
            var username = document.getElementById('username_' + index).innerText.split(': ')[1];
            var password = document.getElementById('password_' + index).innerText.split(': ')[1];
...
<body>
    <div class="container">
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<p id='username_$index'>Username: {$row['username']}</p>";
                echo "<p id='password_$index'>Password: {$row['password']}</p>";
    ...
    <form id="editAdminInfo" method="POST" action="editData.php" style="display: none;">
        ...
        <div>
            ...
            <input type="text" id="edit_suffix" name="suffix" required>
        </div>
        <div>
            <label for="edit_phoneNumber">Phone Number: </label>
            <input type="text" id="edit_phoneNumber" name="phoneNumber" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="passsword" id="edit_password" name="password" required>
        </div>
        <div>
    ...
    <form id="deleteAdminInfo" method="POST" action="deleteData.php" style="display: none;">
        ...
        <div>
            ...
            <input type="text" id="delete_lastName" name="lastName" required>
        </div>
        <div>
            <label for="delete_firstName">First Name: </label>
            <input type="text" id="delete_firstName" name="firstName" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" id="delete_suffix" name="suffix" required>
        </div>
        <div>
            <label for="delete_phoneNumber">Phone Number: </label>
            <input type="text" id="delete_phoneNumber" name="phoneNumber" required>
        </div>
        <div>
            <label for="delete_username">Username</label>
            <input type="text" id="delete_username" name="username">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" id="delete_idNumber" name="idNumber" required>
        </div>
